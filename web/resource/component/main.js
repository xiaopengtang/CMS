...
const async_import = exports.async_import = cb => new Promise(resolve => cb(source => {
	const aim = '__esModule' in source && source.__esModule && source.default || source;
	resolve(aim);
}));

const type = exports.type = data => {
	const r = /\[object (\w+)\]/;
...
const isFunction = exports.isFunction = data => type(data) === 'function';

const isString = exports.isString = data => type(data) === 'string';

const isObject = exports.isObject = data => type(data) === 'object';

const queryString = exports.queryString = (name, search) => {
...
var _reactAddonsCssTransitionGroup = __webpack_require__(50);
...
exports.default = (() => {
	var _ref = _asyncToGenerator(function* (config) {
		const Home = yield _pages2.default.Home;
		return class Base extends _react.Component {
			render() {
				return _react2.default.createElement(Route, { path: '', render: props => {
...
const clientCall = exports.clientCall = (() => {
...
exports.default = {
	get Home() {
		return utils.async_import(resolve => __webpack_require__.e/* require.ensure */(0).then((require => resolve(__webpack_require__(56))).bind(null, __webpack_require__)).catch(__webpack_require__.oe));
	}
};
